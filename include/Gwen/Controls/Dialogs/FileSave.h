...
// Usage:
//
// Gwen::Dialogs::FileOpen( true, "Open Map", "C:\my\folder\", "My Map Format|*.bmf", this,
// &MyClass::OpenFilename );
//
...
//
template <typename A>
void FileSave(bool bUseSystem, const String &Name, const String &StartPath, const String &Extension,
